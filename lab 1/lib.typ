...
#let template(
  ...
  co-author-first-name-1: "Имя Отчество",
  co-author-last-name-1: "Фамилия",
  co-author-first-name-2: "Имя Отчество",
  co-author-last-name-2: "Фамилия",
  author-initials: "И.О.",
...
РОССИЙСКОЙ ФЕДЕРАЦИИ],
  ...
  let co-author-name-1 = co-author-last-name-1+" "+co-author-first-name-1
  let co-author-name-2 = co-author-last-name-2+" "+co-author-first-name-2
  ...
  set document(author: author-name, title: type-of-work)
